...
use PostFinanceCheckout\Payment\Api\Data\TransactionInfoSearchResultsInterfaceFactory;
use PostFinanceCheckout\Payment\Model\ResourceModel\TransactionInfo as TransactionInfoResource;
use PostFinanceCheckout\Payment\Model\ResourceModel\TransactionInfo\CollectionFactory as TransactionInfoCollectionFactory;
...
class TransactionInfoRepository implements TransactionInfoRepositoryInterface
{
    ...
    {
        /** @var \PostFinanceCheckout\Payment\Model\ResourceModel\TransactionInfo\Collection $collection */
        $collection = $this->transactionInfoCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \PostFinanceCheckout\Payment\Api\Data\TransactionInfoSearchResultsInterface $searchResults */
