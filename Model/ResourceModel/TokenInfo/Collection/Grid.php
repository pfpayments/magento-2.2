 ...
 */
namespace PostFinanceCheckout\Payment\Model\ResourceModel\TokenInfo\Collection;
 ...
 */
class Grid extends \PostFinanceCheckout\Payment\Model\ResourceModel\TokenInfo\Collection
{
    ...
    protected function _initSelect()
    {
        ...
        $this->addCustomerIdFilter($this->registry->registry(RegistryConstants::CURRENT_CUSTOMER_ID))
            ->resetSortOrder();
        $this->join([
            'payment_method' => 'postfinancecheckout_payment_method_configuration'
