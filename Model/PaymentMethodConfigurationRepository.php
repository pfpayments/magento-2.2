...
use PostFinanceCheckout\Payment\Api\Data\PaymentMethodConfigurationSearchResultsInterfaceFactory;
use PostFinanceCheckout\Payment\Model\ResourceModel\PaymentMethodConfiguration as PaymentMethodConfigurationResource;
use PostFinanceCheckout\Payment\Model\ResourceModel\PaymentMethodConfiguration\CollectionFactory as PaymentMethodConfigurationCollectionFactory;
...
class PaymentMethodConfigurationRepository implements PaymentMethodConfigurationRepositoryInterface
{
    ...
    {
        /** @var \PostFinanceCheckout\Payment\Model\ResourceModel\PaymentMethodConfiguration\Collection $collection */
        $collection = $this->paymentMethodConfigurationCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \PostFinanceCheckout\Payment\Api\Data\PaymentMethodConfigurationSearchResultsInterface $searchResults */
